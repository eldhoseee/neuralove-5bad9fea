...
const RoastOfTheDay = () => {
  ...
  return (
    <section className="py-8 bg-gradient-to-br from-destructive/5 via-background to-accent/5 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-4">
            <div className="inline-flex items-center gap-2 bg-destructive/10 px-3 py-1.5 rounded-full mb-2">
          ...
          <div className="relative">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-destructive via-accent to-primary rounded-2xl blur-lg opacity-20"></div>
            <div className="relative bg-card/95 backdrop-blur-sm border border-destructive/20 rounded-2xl p-6 md:p-8 shadow-lg">
              {/* Quote marks */}
              <div className="absolute top-3 left-3 text-3xl text-destructive/15 font-serif leading-none">"</div>
              <div className="absolute bottom-3 right-3 text-3xl text-destructive/15 font-serif leading-none rotate-180">"</div>
              
              {/* Roast content */}
              <div className="relative z-10 min-h-[60px] flex items-center justify-center px-6">
                <p className={`text-base md:text-lg text-center font-medium text-foreground leading-relaxed transition-all duration-300 ${
