...
const CognitiveTypes = () => {
  // Show first 4 types for the landing page display (featured types)
  const displayTypes = cognitiveTypes.slice(0, 4);
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto mb-8 md:mb-12">
          {displayTypes.map((type, index) => (
            <Card key={index} className="group p-5 md:p-8 hover:shadow-glow transition-all duration-500 bg-gradient-card border-0 relative overflow-hidden">
              {/* Background pattern */}
        ...
        <div className="text-center">
          ...
          <button className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-primary-glow text-white rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105">
            <span className="font-medium">Discover All 12 Types</span>
